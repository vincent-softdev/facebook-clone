const StoryCard = ({detail}) => {
    return (
        <div style={{backgroundImage: `url(${detail.story_image})`}}
            className="w-[140px] h-[250px] bg-cover rounded-xl bg-center text-white relative font-semibold p-3 pt-5 justify-between flex flex-col bg-no-repeat cursor-pointer transition-all overflow-hidden object-cover">
